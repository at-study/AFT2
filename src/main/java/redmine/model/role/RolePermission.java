...
public enum RolePermission {
    ...
    SET_ISSUES_PRIVATE("Управление видимости (общая/частная) для задач"),
    SET_OWN_ISSUES_PRIVATE("Управление видимости (общая/частная) для собственных задач"),
    ...
    LOG_TIME_FOR_OTHER_USERS("Учитывать время других"),
