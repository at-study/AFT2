...
Функция: 01. Создание, изменение, получение, удаление пользователя. Администратор системы
  ...
  Сценарий:01. Создание, изменение, получение, удаление пользователя. Администратор системы
    ...
    Если Отправить запрос на удаление пользователя "Пользователь12" пользователем "Пользователь11"
    То Получен статус код ответа 204
    То В базе данных отсутствует информация о  пользователе "Пользователь12" созданном "Пользователь11"

    Если Отправить запрос на удаление несуществующего пользователя "Пользователь12" пользователем "Пользователь11"
